...
| `PROCESSING_WORKERS_PER_QUEUE` | How many worker threads should be created per queue. For low-processing environments, set this to '1-2'. The value is always '**lower-bounds**-**upper-bounds**'              | 4-12           | 1-1, 1-4                                  |
